...
public final class SpotifyPlaylistImportService {
    ...
    public init(
        ...
        self.onSpotifyPlaylistImported = onSpotifyPlaylistImported
    }
    ...
    public func importPlaylists(ids: [String]) async throws -> [String] {
    ...
    public func importPlaylist(fromLink link: String) async throws -> String {
...
public enum SpotifyImportError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case let .invalidURL(input):
            "\(input) is not a valid Spotify playlist link or ID."
        case let .emptyPlaylist(name):
            "\(name) has no importable tracks."
        case .sdkUnavailable:
            "Spotify is not connected. Sign in via Settings to import playlists."
        case .noImportablePlaylists:
            "No importable playlists were found in your Spotify library."
        }
    }
}
