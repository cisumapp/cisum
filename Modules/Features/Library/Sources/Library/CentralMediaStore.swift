...
@ModelActor
public actor CentralMediaStore {
    ...
    @discardableResult
    public func upsertArtist(_ snapshot: ArtistSnapshot) -> String {
    ...
    @discardableResult
    public func upsertAlbum(_ snapshot: AlbumSnapshot) -> String {
    ...
    @discardableResult
    public func upsertSong(_ snapshot: SongSnapshot) -> String {
    ...
    @discardableResult
    public func upsertPlaylist(_ snapshot: PlaylistSnapshot) -> String {
    ...
    public struct ProviderIDsSnapshot: Sendable {
        public let youtubeVideoID: String?
        public let youtubeMusicVideoID: String?
    ...
    public func cachedProviderIDs(forSpotifyTrackID spotifyTrackID: String) -> ProviderIDsSnapshot? {
        guard let song = songBySpotifyTrackID(spotifyTrackID) else { return nil }
        return ProviderIDsSnapshot(
            youtubeVideoID: song.youtubeVideoID,
            youtubeMusicVideoID: song.youtubeMusicVideoID,
            tidalID: song.tidalID,
            qobuzID: song.qobuzID,
    ...
    public func cacheSpotifyPlaybackTarget(
        ...
        switch provider {
        case .youtube:
            song.youtubeVideoID = mediaID
        case .youtubeMusic:
            song.youtubeMusicVideoID = mediaID
        case .spotify:
            song.spotifyTrackID = mediaID
        case .appleMusic:
            song.appleMusicSongID = mediaID
        case .tidal:
            song.tidalID = mediaID
        case .qobuz:
            song.qobuzID = mediaID
        case .soundcloud:
            song.soundcloudID = mediaID
        case .deezer:
            song.deezerID = mediaID
        default:
            break
        }
...
#if canImport(SpotifySDK)
public extension CentralMediaStore {
    @discardableResult
    func upsertSpotifyArtist(_ artist: SpotifyArtist) -> String {
    ...
    @discardableResult
    func upsertSpotifyAlbum(_ album: SpotifyAlbum) -> String {
        ...
        let snapshot = AlbumSnapshot(
            ...
            primaryArtistID: primaryArtistEntry,
    ...
    @discardableResult
    func upsertSpotifyTrack(_ track: SpotifyTrack) -> String {
    ...
    @discardableResult
    func upsertSpotifyPlaylist(_ playlist: SpotifyPlaylist) -> String {
        let snapshot = PlaylistSnapshot(
            ...
            trackIDs: playlist.tracks?.items.map { upsertSpotifyTrack($0) } ?? []
        )
    ...
    @discardableResult
    func upsertSpotifyTracks(_ tracks: [SpotifyTrack]) -> [String] {
        tracks.map { upsertSpotifyTrack($0) }
    }

    @discardableResult
    func upsertSpotifyArtists(_ artists: [SpotifyArtist]) -> [String] {
        artists.map { upsertSpotifyArtist($0) }
    }

    @discardableResult
    func upsertSpotifyPlaylists(_ playlists: [SpotifyPlaylist]) -> [String] {
...
public struct CentralMediaStoreKey: EnvironmentKey {
    public static let defaultValue: CentralMediaStore? = nil
}
